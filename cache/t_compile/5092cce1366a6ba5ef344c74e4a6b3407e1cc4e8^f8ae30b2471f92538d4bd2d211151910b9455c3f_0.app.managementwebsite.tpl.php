<?php
/* Smarty version 4.5.5, created on 2025-10-31 01:06:13
  from 'app:managementwebsite.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6903a9155c0180_18010274',
...
function content_6903a9155c0180_18010274 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_18195357286903a91559b119_34771627', "page");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "layouts/backend.tpl");
}
/* {block "page"} */
class Block_18195357286903a91559b119_34771627 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_18195357286903a91559b119_34771627',
  ),
);
...
">
					<pkp-form
						v-bind="components.<?php echo APP\components\forms\context\AppearanceSetupForm::FORM_APPEARANCE_SETUP;?>
"
						@set="set"
					/>
				</tab>
				<tab id="appearance-masthead" label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"common.editorialMasthead"),$_smarty_tpl ) );?>
">
					<pkp-form
						v-bind="components.<?php echo PKP\components\forms\context\PKPAppearanceMastheadForm::FORM_APPEARANCE_MASTHEAD;?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo APP\components\forms\context\AppearanceAdvancedForm::FORM_APPEARANCE_ADVANCED;?>
"
						@set="set"
					/>
				</tab>
...
">
						<pkp-form
							v-bind="components.<?php echo PKP\components\forms\context\PKPInformationForm::FORM_INFORMATION;?>
"
							@set="set"
						/>
					</tab>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>PKP\core\PKPApplication::ROUTE_COMPONENT,'component'=>"grid.settings.languages.SubmissionLanguageGridHandler",'op'=>"fetchGrid",'escape'=>false),$_smarty_tpl ) );
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
...
">
					<pkp-form
						v-bind="components.<?php echo PKP\components\forms\context\PKPListsForm::FORM_LISTS;?>
"
						@set="set"
					/>
				</tab>
...
">
					<pkp-form
						v-bind="components.<?php echo PKP\components\forms\context\PKPPrivacyForm::FORM_PRIVACY;?>
"
						@set="set"
					/>
				</tab>
...
">
					<date-time-form
							v-bind="components.<?php echo PKP\components\forms\context\PKPDateTimeForm::FORM_DATE_TIME;?>
"
							@set="set"
					/>
				</tab>
